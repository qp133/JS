...
function Counter() {
    ...
    const changeProduct = () => {
        ...
        let rdName = Math.random() + "new name product";
    ...
    return (
        <>
            ...
            {show && (
                ...
                Voluptatem cum expedita, enim cumque laboriosam eveniet 
                deleniti officia iusto exercitationem ut.</p>
            )}
